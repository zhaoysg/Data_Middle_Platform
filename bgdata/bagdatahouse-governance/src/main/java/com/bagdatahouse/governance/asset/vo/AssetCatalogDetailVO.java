...
@AllArgsConstructor
@Builder
@ApiModel(description = "资产目录详情")
public class AssetCatalogDetailVO {
    ...
    @ApiModelProperty("专辑说明")
    private String albumDesc;

    @ApiModelProperty("收录的资产列表")
    private List<CatalogAssetVO> assets;

    @ApiModelProperty("子目录列表")
    private List<AssetCatalogTreeVO> children;
}
