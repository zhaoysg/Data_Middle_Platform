...
INSERT INTO ry_bigdata_v1.sys_datasource (tenant_id,ds_name,ds_code,ds_type,host,port,database_name,schema_name,username,password,connection_params,data_layer,dept_id,status,del_flag,remark,create_dept,create_by,create_time,update_by,update_time) VALUES
	 ('000000','Mysql_ods','Mysql_ods','MYSQL','49.232.153.150',3366,'biji_db',NULL,'root','sdfwer@re3f',NULL,'ODS',NULL,'0','0','',103,1,'2026-03-30 19:41:29',1,'2026-03-30 22:29:01');
